...
export interface SecurityEvent {
  id: string;
  timestamp: string;
  eventType: "RUG_PULL_DETECTED" | "SHADOW_MCP_BLOCKED" | "CHAIN_BROKEN" | "LATERAL_MOVEMENT" | "INJECTION_DETECTED" | "INJECTION_DETECTED_IN_OUTPUT" | "CONFIG_CHANGE_BLOCKED" | "SECRETS_IN_OUTPUT" | "EXTERNAL_CONTENT_STRIPPED";
