...
export default defineConfig({
  resolve: {
    alias: {
      "@stlw/warden": resolve(__dirname, "packages/core/src/index.ts"),
      "@stlw/warden-hook-server": resolve(__dirname, "packages/hook-server/src/server.ts"),
      "@stlw/warden-mcp-gateway": resolve(__dirname, "packages/mcp-gateway/src/gateway.ts"),
      "@stlw/warden-cli": resolve(__dirname, "packages/cli/src/index.ts"),
      "@stlw/warden-opencode-plugin": resolve(__dirname, "packages/opencode-plugin/warden-plugin.ts"),
    },
  },
  test: {
    globals: true,
